...
if utils.enabled(group, "telescope") then
  ...
  local colorschemes = {
    ...
    },
    {
      ...
      family = "catppuccin",
      module = "catppuccin",
      transparent_key = "transparent_background",
    },
    {
    ...
    },
    {
      ...
      family = "nightfox",
      module = "nightfox",
      transparent_key = "options.transparent",
    },
    {
      name = "duskfox",
      family = "nightfox",
  ...
  local function set_transparency(entry, enabled)
    if not entry.module or not entry.transparent_key then
      return
    end
    ...
    local picker = pickers.new({}, {
      ...
      attach_mappings = function(prompt_bufnr, map)
        ...
        actions.select_default:replace(function()
          ...
          utils.notify_info(
            selection.value.name .. (transparent and " (transparent)" or ""),
            "Colorscheme"
          )
        end)
